 ...
 * 
 */
@WebServiceClient(name = "NewWebService", targetNamespace = "http://service.heroku.chamerling.org/", wsdlLocation = "http://localhost:9191/NewService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName NEWWEBSERVICE_QNAME = new QName("http://service.heroku.chamerling.org/", "NewWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9191/NewService?wsdl");
    ...
    public NewWebService getNewWebServicePort() {
        return super.getPort(new QName("http://service.heroku.chamerling.org/", "NewWebServicePort"), NewWebService.class);
    }
    ...
    public NewWebService getNewWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.heroku.chamerling.org/", "NewWebServicePort"), NewWebService.class, features);
    }
