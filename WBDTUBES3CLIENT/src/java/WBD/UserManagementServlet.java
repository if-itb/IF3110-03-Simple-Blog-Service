...
//    @WebServiceRef(wsdlLocation = "WEB-INF/wsdl/spargo.herokuapp.com/SimpleBlog.wsdl")
//    private SimpleBlog_Service service;
...
//            ArrayList<User> users = UserDAO.getAllUsers();
            List<User> users = (ArrayList<User>)SimpleBlogService.listUser();
