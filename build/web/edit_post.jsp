...
<jsp:include page ="/edit_post"/>

<%  
    String[] editData = (String[])request.getAttribute("edit_data");
        ...
        <div class="art-body-inner">
            ...
            <div id="contact-area">
                <form method="post" action="edit_post">
                    ...
                    <input type="text" name="Judul" id="Judul" placeholder="Judul" value = "<%out.println(editData[1]);%>">

                    <label for="Tanggal">Tanggal:</label>
                    <input type="text" name="Tanggal" id="Tanggal" placeholder="yyyy-mm-dd" value = "<%out.println(editData[2]);%>">
                    
                    <label for="Konten">Konten:</label><br>
                    <textarea name="Konten" rows="20" cols="20" id="Konten" placeholder="Isi Artikel"><%out.println(editData[3]);%></textarea>
                    
                    <input type ="hidden" name ="id_post" value ="<%out.println(request.getParameter("id"));%>"> </input>
