                        ...
                        <ul class="art-list-body">
                            <%
                                ...
                                if (cookies != null) {
                                    ...
                                    ArrayList<Post> list = (ArrayList) SimpleBlogService.listUnpublishedPost();
                                    for (Post post : list) {
                            %>
                            <li class="art-list-item">
                                ...
                                <p>
                                    <a href="publish.jsp?post=<% out.print(post.getId());%>">Publish</a> | <a href="delete.jsp?post=<% out.print(post.getId());%>">Hapus</a>
                                </p>
                            </li>
                            <%
                                    }
