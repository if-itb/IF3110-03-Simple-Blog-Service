...
//        comment.setId(Integer.valueOf(request.getParameter("idpost")));
        ...
        int id = Integer.valueOf(request.getParameter("idpost"));
...
//        ArrayList<Comment> comments = CommentDAO.get(Integer.valueOf(request.getParameter("idpost")));
        ArrayList<Comment> comments = SimpleBlogService.listComment(Integer.valueOf(request.getParameter("idpost")));
