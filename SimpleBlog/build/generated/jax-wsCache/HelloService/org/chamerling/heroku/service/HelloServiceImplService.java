 ...
 * 
 */
@WebServiceClient(name = "HelloServiceImplService", targetNamespace = "http://service.heroku.chamerling.org/", wsdlLocation = "http://kelompok14wbd3.herokuapp.com/HelloService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://kelompok14wbd3.herokuapp.com/HelloService?wsdl");
    ...
    public HelloServiceImpl getHelloServiceImplPort() {
        return super.getPort(new QName("http://service.heroku.chamerling.org/", "HelloServiceImplPort"), HelloServiceImpl.class);
    }
    ...
    public HelloServiceImpl getHelloServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.heroku.chamerling.org/", "HelloServiceImplPort"), HelloServiceImpl.class, features);
    }
