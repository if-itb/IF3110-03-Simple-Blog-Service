 ...
 * @author DiePiePaw
 */
@WebServlet(urlPatterns = {"/SoftDelete"})
public class SoftDeleteServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SoftDeleteServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet SoftDeleteServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
//                if (!PostDAO.softDelete(Integer.valueOf(id))) {                
                if (!SimpleBlogService.deletePost(Integer.valueOf(id))) {
