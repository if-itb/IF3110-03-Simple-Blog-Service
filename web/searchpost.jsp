<%-- 
    Document   : searchpost
    Created on : Dec 19, 2014, 4:37:33 AM
    Author     : Yanfa
--%>
...
<%
	...
	listPost = WSDLConnector.search(request.getParameter("searchquery"));
...
<nav class="nav">
    ...
    <h:form rendered="#{!loginHandler.login}">
		...
		<a href="../build/generated-sources/jax-ws/org/chamerling/heroku/service/PostModel.java"></a>
  ...
  <form method="post" style="position:absolute;right:5px;top:inherit;" action="searchpost.jsp" method="post">
	  <input type="text">
        ...
        <nav class="art-list">
          <ul class="art-list-body">
            ...
            <li class="art-list-item">
                ...
                <p>
                    <f:subview id="asd" rendered="#{loginHandler.login}"><a href="update_post.jsp?postId=<% out.print(pm.getId()); %>">Edit</a> | <a href="delete_post.jsp?postId=<% out.print(pm.getId()); %>" onclick="return confirm('Apa kamu yakin untuk menghapus post ini?');">Hapus</a>
                    </f:subview>
                </p>
            </li>
			<%}}%>
