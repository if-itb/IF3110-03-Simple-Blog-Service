 ...
 * 
 */
@WebServiceClient(name = "HelloServiceImplService", targetNamespace = "http://service.heroku.chamerling.org/", wsdlLocation = "http://simplewebservice.herokuapp.com/HelloService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://simplewebservice.herokuapp.com/HelloService?wsdl");
