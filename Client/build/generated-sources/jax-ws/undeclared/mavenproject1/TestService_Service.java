 ...
 * 
 */
@WebServiceClient(name = "TestService", targetNamespace = "http://mavenproject1.undeclared/", wsdlLocation = "http://radiant-coast-5679.herokuapp.com/TestService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName TESTSERVICE_QNAME = new QName("http://mavenproject1.undeclared/", "TestService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://radiant-coast-5679.herokuapp.com/TestService?wsdl");
    ...
    public TestService getTestServicePort() {
        return super.getPort(new QName("http://mavenproject1.undeclared/", "TestServicePort"), TestService.class);
    }
    ...
    public TestService getTestServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://mavenproject1.undeclared/", "TestServicePort"), TestService.class, features);
    }
